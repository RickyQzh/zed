...
pub use panel::{OpenCanvas, OpenSelectedSource, Reindex, SemanticMapPanel, ToggleFocus};
...
pub use view_model::{
    CanvasViewModel, PanelRow, PanelStatus, PanelViewModel, SceneEdge, SceneNode, orientation_lens,
};
