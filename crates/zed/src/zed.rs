...
use semantic_map_ui::SemanticMapPanel;
use paths::{
...
fn initialize_panels(window: &mut Window, cx: &mut Context<Workspace>) -> Task<anyhow::Result<()>> {
    cx.spawn_in(window, async move |workspace_handle, cx| {
        ...
        let semantic_map_panel = SemanticMapPanel::load(workspace_handle.clone(), cx.clone());
        ...
        futures::join!(
            ...
            add_panel_when_ready(semantic_map_panel, workspace_handle.clone(), cx.clone()),
